...
return [
    ...
    */
    ...
    'prefixes' => [
        ...
        'route' => 'Frontend',  // using admin will create route('admin.?.index') type routes

        'path' => 'Frontend',

        'view' => 'Frontend',  // using Frontend will create return view('Frontend.?.index') type the Frontend views directory
