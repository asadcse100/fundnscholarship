...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b> Institution </b>Registration</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('inn_no') ? ' has-error' : '' }}">
                <input required type="inn_no" class="form-control" name="inn_no" placeholder="Inn Number">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>

                @if ($errors->has('inn_no'))
                    <span class="help-block">
                        <strong>{{ $errors->first('inn_no') }}</strong>
                    </span>
                @endif
            </div>
