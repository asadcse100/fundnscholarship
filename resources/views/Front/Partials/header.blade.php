                ...
                <nav class="navbar">
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="navbar-brand" href="http://www.bangladesh.gov.bd/index.php?lang=en"><img src="{{ asset('img/444.png')}}" class="img-responsive"></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="menu">
            <div class="container">
                <ul class="main-navigation">
                    <li style="font-weight: 400"><a href="{{ Route('home') }}">Home</a></li>
...
@endif
                    ...
                    <li><a href="{{asset('pdf/faq.pdf')}}">FAQ's</a></li>
                    ...
                    <li><a href="#">Complains</a>
                        ...
                        <li><a href="{!! route('frontend.complains.index') !!}">View Complain Status</a></li>
