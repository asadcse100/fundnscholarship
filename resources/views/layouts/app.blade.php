...
<body class="skin-blue sidebar-mini" background="img/login.png">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a class="logo" href="{{ route('admin.home') }}">
                    {{ config('app.name', 'Scholarship portal') }} {{ ucfirst(config('multiauth.prefix')) }}
                </a>
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    ...
                    @admin('super')
                        <a class="btn btn-default btn-flat" href="{{ route('admin.show') }}">{{ ucfirst(config('multiauth.prefix')) }}</a>
