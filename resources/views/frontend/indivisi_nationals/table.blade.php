<table class="table table-responsive" id="indivisiNationals-table">
    ...
    @foreach($indivisiNationals as $indivisiNational)
        <tr>
            ...
            <td>
                {!! Form::open(['route' => ['frontend.indivisiNationals.destroy', $indivisiNational->id], 'method' => 'delete']) !!}
                <div class='btn-group'>
                    <a href="{!! route('frontend.indivisiNationals.show', [$indivisiNational->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('frontend.indivisiNationals.edit', [$indivisiNational->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
