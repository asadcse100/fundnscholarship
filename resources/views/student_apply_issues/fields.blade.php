...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('issue_image', null, ['class' => 'form-control']) !!}
</div>

<!-- Video Link Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('video_link', 'Video Link:') !!}
    {!! Form::textarea('video_link', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('studentApplyIssues.index') !!}" class="btn btn-default">Cancel</a>
</div>
